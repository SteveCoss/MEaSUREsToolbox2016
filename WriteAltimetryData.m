...
XLimId = netcdf.defDim(sGroupID,'lon_Limits',2);
YDimId = netcdf.defDim(sGroupID,'latbox',length(VS.Y)-1);
YLimId = netcdf.defDim(sGroupID,'lat_limits',2);
...
l3DimId = netcdf.defDim(UGDR_GroupID,'l3',ntAll);
vIDs.UGDR_Lon=netcdf.defVar(UGDR_GroupID,'lon','NC_DOUBLE',l3DimId);
vIDs.UGDR_Lat=netcdf.defVar(UGDR_GroupID,'lat','NC_DOUBLE',l3DimId);
vIDs.UGDR_h=netcdf.defVar(UGDR_GroupID,'h','NC_DOUBLE',l3DimId);
...
vIDs.UGDR_t=netcdf.defVar(UGDR_GroupID,'time','NC_DOUBLE',l3DimId);
...
demdimid = netcdf.defDim(ncid,'DEMused',length(Filter.DEMused));
...
netcdf.putAtt(UGDR_GroupID,vIDs.UGDR_t,'units','days since 0000-01-00 00:00:00');
...
netcdf.putVar(sGroupID,vIDs.YLim,ylim);
 netcdf.putVar(sGroupID,vIDs.Island,VS.Island); 
...
netcdf.putVar(UGDR_GroupID,vIDs.UGDR_t,VS.AltDat.tAll);
